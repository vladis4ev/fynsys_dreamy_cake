...
State.prototype.getManifest = function(){
    var manifest = [
        ...
        {name: "finalVoice_01", url: "sound/s-55.mp3?rand=<?=time()?>"},
        {name: "finalVoice_02", url: "sound/s-56.mp3?rand=<?=time()?>"},
        /*{name: "finalVoice_03", url: "sound/an-34.mp3"},*/
        {name: "sadVoice_01", url: "sound/s-60.mp3?rand=<?=time()?>"},
        {name: "sadVoice_02", url: "sound/s-70.mp3?rand=<?=time()?>"},
        /*{name: "sadVoice_03", url: "sound/an-32.mp3"},*/
        {name: "persVoice_01", url: "sound/s-24.mp3?rand=<?=time()?>"},
        {name: "persVoice_02", url: "sound/s-39.mp3?rand=<?=time()?>"},
        {name: "persVoice_03", url: "sound/s-58.mp3?rand=<?=time()?>"},
        {name: "persVoice_04", url: "sound/s-71.mp3?rand=<?=time()?>"},
        {name: "persVoice_05", url: "sound/s-73.mp3?rand=<?=time()?>"}
    ];
    return manifest;
}
